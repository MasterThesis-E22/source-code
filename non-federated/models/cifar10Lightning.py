...
from torchvision.models import SqueezeNet, mobilenet_v3_small

from config.nonFederatedConfig import NonFederatedConfig
from dataset.cifar10 import Cifar10
from dataset.mnist import MNIST
from models.models import Cifar10LowGPUCNN


class Cifar10Lightning(LightningModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_data = cifar.get_train_dataset()
        self.valid_data = cifar.get_valid_dataset()
        self.test_data = cifar.get_test_dataset()
